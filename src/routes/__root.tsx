...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Insaf Trading — Business Control Dashboard" },
      { name: "description", content: "Modern trading & inventory control panel with real-time cash flow, stock alerts and sales insights." },
      { name: "author", content: "Insaf Trading" },
      { property: "og:title", content: "Insaf Trading — Business Control Dashboard" },
